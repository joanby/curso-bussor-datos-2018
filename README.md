# Curso de análisis de Datos Bussor
...
- **03-Clase3**: Representación de gráficos con el paquete básico stats (scatterplots, histogramas, boxplot...)
- **04-Clase4**: Generación de gráficos con *ggplot* de *tidyverse*.
